...
export const allProjectsData: Project[] = [
  ...
  },
  {
    ...
    description: "Implemented a wide range of account management, paper trading, and options chain features, as well as a homepage, login/registration screen, dashboard, and options chain. Wrote several APIs to retrieve data from MySQL after processing it for use in strategy execution, options trading, and paper trading.",
  ...
  },
  {
    ...
    description: "This website visualizes various sorting techniques like bubble sort, quick sort, insertion sort, selection sort, merge sort, shell sort and heap sort. Sorting animation speed can be changed while the array is sorted. You can generate arrays ranging from size 2 to 100 and randomize them.",
  ...
  // Archive Projects (previously in projectsArchive)
  {
    ...
    date: "May 2023",
    description: "A simple list management application built with TypeScript for task organization and productivity.",
    tags: ["TypeScript"],
    isFeatured: false,
    isVisible: true
  },
  {
    ...
    date: "May 2023",
    description: "Complete authentication system using MERN stack with JWT tokens, secure password hashing, and user session management.",
  ...
  },
  {
    ...
    date: "Jan 2023",
    description: "Collaborative code editor with real-time synchronization, multiple language support, and team workspace features.",
  ...
  },
  {
    ...
    date: "Sept 2022",
    description: "Weather application with location-based forecasting, real-time weather updates, and responsive design.",
  ...
  },
  {
    ...
    date: "Mar 2022",
    description: "IoT project demonstrating MQTT protocol implementation with real-time message publishing and subscribing.",
    tags: ["ReactJS", "MQTT"],
    isFeatured: false,
    isVisible: true
  },
  {
    ...
    date: "Feb 2022",
    description: "First version of my personal portfolio website built with React, showcasing my early web development skills.",
    tags: ["ReactJS"],
    isFeatured: false,
    isVisible: true
  },
  {
    ...
    date: "Oct 2021",
    description: "Implementation of the Travelling Salesman Problem using Hill Climbing algorithm with visualization and performance analysis.",
  ...
  },
  {
    ...
    date: "Sept 2021",
    description: "Command-line tic-tac-toe game with AI opponent using minimax algorithm for intelligent gameplay.",
    tags: ["Python"],
    isFeatured: false,
    isVisible: true
  },
  {
    ...
    date: "Sept 2020",
    description: "Complete university management system with student registration, course management, grade tracking, and faculty modules.",
    tags: ["Java", "MySQL"],
    isFeatured: false,
    isVisible: true
  },
  {
    ...
    date: "Aug 2020",
    description: "Banking system with account management, transaction processing, balance inquiry, and customer management features.",
    tags: ["Java", "MySQL"],
    isFeatured: false,
    isVisible: true
  }
