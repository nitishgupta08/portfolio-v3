...
export const fallbackExperienceData: Experience[] = [
  {
    ...
    endDate: null,
    description: "Currently working on cutting-edge software development projects using modern programming languages and frameworks.",
    tags: ["Python", "C", "C++"],
    isVisible: true
  },
  {
    ...
    endDate: "2023-12-31",
    description: "I optimized multiple APIs, resulting in faster response times and improved system efficiency. I implemented new features aligned with business logic using Django and Django Rest Framework (DRF), and I wrote unit, integration, and end-to-end tests to ensure code reliability. Additionally, I developed GitHub workflows to automate our test suite, streamlining the development process and facilitating seamless integration of new features.",
